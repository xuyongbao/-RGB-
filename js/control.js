$(document).ready(function() {
    ...
    /* window.fb.setColor("rgb(255,0,255");
    ...
    var lightWidth = $('.lighteness').width();
    // var r = dataProcessing(brightness);//初始亮度，最低
    ...
    $(".lighteness").on("touchstart",function (e) {
        ...
        startX = x;
        startY = y;
        $(".lighteness").on("touchmove",lightmove);
        $(document).on("touchend",lightend);
    });
    function lightmove(e){
        ...
        if(len >= 5 && $(".bulb").hasClass("on")){ 
            ...
            var r = dataProcessing(actualTime);
    ...
    function lightend(e){
        ...
        $(".lighteness").off("touchmove",lightmove);
        $(document).off("touchend",lightend);
        ...
        bindEvent:function(){
            ...
            $(".light_on_off").on("click",function(){
                if($(this).hasClass("off")){//开灯 
                    ...
                    $(".light_switch").find(".switch_txt").text("白灯");
                }
            });
            //监听颜色的变化
            $(".farbtastic").on("touchstart",function(){
