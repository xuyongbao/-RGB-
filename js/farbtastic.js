...
jQuery._farbtastic = function (container, callback) {
  ...
  fb.widgetCoords = function (event) {
    ...
    if (typeof event.offsetX != 'undefined') {
      ...
      x = (event.touches[0].pageX || 0*(event.clientX + $('html').get(0).scrollLeft)) - pos.x;
      y = (event.touches[0].pageY || 0*(event.clientY + $('html').get(0).scrollTop)) - pos.y;
    }
